...
return [
	...
	*/
	...
	'custom' => [
	    ...
	    'principal' => [
	        'required' => 'Especifica si la alerta es principal.',
	        'max' => 'El campo alerta principal admite hasta :max caracter.',
	        'numeric' => 'El campo alerta princiál debe ser un número.'
	    ],
	    'titulo' => [
	        'required' => 'Ingresa el título de la alerta.',
	        'max' => 'El título debe contener máximo :max letras.'
	    ],
	    'feini' => [
	        'required' => 'Selecciona una fecha de inicio de la alerta.',
	        'date' => 'La fecha inicio debe ser formato fecha.'
	    ],
	    'fefin' => [
	        'required' => 'Selecciona una fecha fin de la alerta.',
	        'date' => 'La fecha fin debe ser formato fecha.'
	    ],
	    'newAdviser' => [
	        'required' => 'Especifica si la alerta es para asesoras nuevas o antiguas.'
	    ],
	    'my_multi_select2' => [
	        'required' => 'Selecciona las zonas a las que aplica la alerta.'
	    ],
	    'current_password' => [
	        'required' => 'Ingresa tú contraseña actual.',
	        'max' => 'Tú contraseña debe contener máximo :max caracteres.'
	    ],
	    'password' => [
            'required' => 'Ingresa tú nueva contraseña.',
            'max' => 'Tú nueva contraseña debe tener máximo :max caracteres.'
	    ],
	    'password_confirm' => [
	        'required' => 'Confirma tú nueva contraseña.',
	        'max' => 'Tú nueva contraseña debe tener máximo :max caracteres.',
	        'same' => 'Tú nueva contraseña no coinside, ingresala de nuevo.'
	    ]
	],
