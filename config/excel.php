...
return array(
    ...
    'properties' => [
        'creator'        => 'Gerencia TI',
        'lastModifiedBy' => 'Gerencia TI',
        'title'          => 'Exportación Pedidos Web',
        'description'    => 'Archivo de exportación pedidos web',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'pedidos, excel, lineadirecta',
        'category'       => 'Pedidos',
        'manager'        => 'Gerencia TI',
        'company'        => 'Linea Directa',
    ],
